...
namespace LinqLabs.AdventureTableAdapters {
...
SELECT ProductPhotoID, ThumbNailPhoto, ThumbnailPhotoFileName, LargePhoto, LargePhotoFileName, ModifiedDate FROM Production.ProductPhoto WHERE (ProductPhotoID = @ProductPhotoID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT  ProductPhotoID LargePhoto FROM Production.ProductPhoto WHERE ProductPhoto" +
                "ID=@ProductPhotoID";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ProductPhotoID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "LargePhoto", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[2].CommandText = "SELECT ProductPhotoID, ThumbNailPhoto, ThumbnailPhotoFileName, LargePhoto, LargeP" +
                "hotoFileName, ModifiedDate FROM Production.ProductPhoto\r\n\r\nwhere  month(Modified" +
                "Date) between 5 and 9";
        ...
        public virtual int FillByPhoto(Adventure.ProductPhotoDataTable dataTable, int ProductPhotoID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ProductPhotoID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
            int returnValue = this.Adapter.Fill(dataTable);
        ...
        public virtual Adventure.ProductPhotoDataTable GetDataBy1(int ProductPhotoID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ProductPhotoID));
            Adventure.ProductPhotoDataTable dataTable = new Adventure.ProductPhotoDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByS1(Adventure.ProductPhotoDataTable dataTable) {
